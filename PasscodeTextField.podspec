Pod::Spec.new do |spec|
  spec.name = "PasscodeTextField"
  spec.version = "1.0.1"
  spec.summary = "PasscodeTextField is just a simple CoreFoundationKit utility Module"

  spec.description = <<-DESC
  This module contains the tab bar controller with a circular button at center
                   DESC

  spec.homepage = "https://github.com/prashantLalShrestha/PasscodeTextField"
  ...
  # spec.source = { :git => '' }
  spec.source = { 
    :git => "https://github.com/prashantLalShrestha/PasscodeTextField.git", :tag => spec.version.to_s
  }
